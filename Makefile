...
BUILD		:=	build
SOURCES		:=	src src/Enemies src/Headers src/Items src/Player src/QD3D src/Ride src/Screens src/Skeleton src/System src/Terrain
DATA		:=	Data
...
CFLAGS	:=	-g -Wall -Wno-unknown-pragmas -Wno-multichar -O2 -mword-relocations \
			-ffunction-sections \
			$(ARCH)
...
LIBS	:= -lSDL2 -lPomme -lpicaGL -lctru -lm
